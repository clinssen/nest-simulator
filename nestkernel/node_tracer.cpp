...
nest::Node_Tracer::Node_Tracer( const Node_Tracer& n )
  : Node( n )
...
void
Node_Tracer::register_stdp_connection( double t_first_read )
{
...
double
nest::Node_Tracer::get_K_value( double t )
{
  if ( history_.empty() )
  {
    return Kminus_;
...
void
nest::Node_Tracer::get_K_values( double t,
  double& K_value,
...
void
nest::Node_Tracer::get_history( double t1,
  double t2,
...
void
nest::Node_Tracer::get_status( DictionaryDatum& d ) const
{
...
void
nest::Node_Tracer::set_status( const DictionaryDatum& d )
{
...
void
nest::Node_Tracer::clear_history()
{
  last_spike_ = -1.0;
  Kminus_ = 0.0;
  triplet_Kminus_ = 0.0;
...
inline double
Node_Tracer::get_Ca_minus() const
{
  return Ca_minus_;
}
