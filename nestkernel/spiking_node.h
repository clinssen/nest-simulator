...
/**
 * \file spiking_node.h
 * Definition of Spiking_Node which is capable of
 * recording and managing a spike history.
 * \author Moritz Helias, Abigail Morrison
 * \date april 2006
 */

#ifndef SPIKING_NODE_H
#define SPIKING_NODE_H
 ...
 */
class Spiking_Node : public Node
{
...
public:
   ...
   * Copy Constructor.
   */
  Spiking_Node( const Spiking_Node& );
...
private:
  ...
  std::vector< Node_Tracer* > tracers_;

};

inline double
Spiking_Node::get_spiketime_ms() const
{
  return last_spike_;
}

inline double
Spiking_Node::get_tau_Ca() const
{
  return tau_Ca_;
}

inline double
Spiking_Node::get_Ca_minus() const
{
  return Ca_minus_;
}
